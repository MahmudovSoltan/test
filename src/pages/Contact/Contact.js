            ...
            <div style={{ width: "100vw", height: "100vh", display: "flex" }}>
              <form class="formContainer">
                <div class="formElement">
                  <input
                    className={
                      nameError ? "formElement_input2" : "formElement_input"
                    }
                    type="text"
                    id="from_name"
                    name="from_name"
                  ...
                  <input
                    className={
                      emailError ? "formElement_input2" : "formElement_input"
                    }
                    type="email"
                    id="from_email"
                    name="from_email"
                ...
                <div class="formElement2">
                  <input
                    className={
                      numberError ? "formElement2_input2" : "formElement2_input"
                    }
                    type="email"
                    id="from_email"
                    name="from_email"
                ...
                <div class="formElement2">
                  <textarea
                    className={
                      textError
                        ? "formElement2_textarea2"
                        : "formElement2_textarea"
                    }
                    name="message"
                    rows="8"
                    cols="30"
                ...
                <button
                  type="submit"
                  className={error ? "btn_color" : "formButton"}
